...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
        ...
        public PlayPingPongThread(String stringToPrint,
                                  ...
                                  int maxIterations) {
            // TODO - You fill in here.
        	semaphoreString = stringToPrint;
        	pingSemaphore = semaphoreOne;
        	pongSemaphore = semaphoreTwo;
        ...
        public void run() {
        	...
        	for(int i = 1; i<=mMaxLoopIterations; i++) {
        		acquire();
        		System.out.println(semaphoreString + "(" + i + ")");
        		release();
        	}
        	mLatch.countDown();
        ...
        void acquire() {
            //TODO fill in here
        	pingSemaphore.acquireUninterruptibly();
